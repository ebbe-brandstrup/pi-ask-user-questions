> Attribution: This repository is based verbatim on the original `ask-user-question` Pi extension by emanuelcasco:

> https://github.com/emanuelcasco/pi-mono-extensions/tree/main/extensions/ask-user-question

## Install from git

Add this repository to your Pi `settings.json` packages list:

```json
{
  "packages": [
    "git:github.com/ebbe-brandstrup/pi-ask-user-questions"
  ]
}
```

Then reload Pi or restart the session.
